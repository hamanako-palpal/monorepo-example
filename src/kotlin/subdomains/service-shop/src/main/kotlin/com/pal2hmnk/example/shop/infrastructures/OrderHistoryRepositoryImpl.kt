...
import com.pal2hmnk.example.domain.shop.entities.Name
...
import com.pal2hmnk.example.domain.shop.entities.ShopId
...
class OrderHistoryRepositoryImpl(
    ...
    private fun findShopsRecordListByShopIds(shopIds: List<Int>): List<ShopsRecord> =
